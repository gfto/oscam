...
extern READER_STAT *get_stat(struct s_reader *rdr, uint16_t caid, uint32_t prid, uint16_t ecmpid, uint16_t srvid, uint16_t chid, int16_t ecmlen);
extern READER_STAT *get_fastest_stat(uint16_t caid, uint32_t prid, uint16_t ecmpid, uint16_t srvid, uint16_t chid, int16_t ecmlen);
...
extern int32_t clean_stat_by_id(struct s_reader *rdr, uint32_t caid, uint32_t provid, uint16_t ecmpid, uint32_t sid, uint32_t cid, uint32_t len);
