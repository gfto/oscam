...
int32_t matching_reader(ECM_REQUEST *er, struct s_reader *rdr, int32_t slot) {
  ...
  // CDS NL: check for right seca type does apply for TVV and Telesat ass well
  if (!is_network_reader(rdr) && er->caid == 0x100 && (er->prid == 0x00006a || er->prid == 0x00006c || er->prid == 0x00006d) &&
  ...
  // CDS NL: check for right seca type by ECMPID does apply for TVV and Telesat ass well 
  if (!is_network_reader(rdr) && er->caid == 0x100 && (er->prid == 0x00006a || er->prid == 0x00006c || er->prid == 0x00006d)){
