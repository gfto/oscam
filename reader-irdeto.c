...
static time_t chid_date(struct s_reader * reader, uint32_t date, char *buf, int32_t l)
{
    ...
    CHID_BASE_DATE table[] = { {0x0604, 0x1541, "GRC", 977817600L},    // 26.12.2000, 00:00
							   ...
							   {0x0602, 0x0606, "NLD", 946594800L},    // 31.12.1999, 08:00    //Ziggo irdeto caid: 0602, acs: 6.06
							   ...
							   {0x0606, 0x0606, "NLD", 946594800L},    // 31.12.1999, 00:00    //Caiway irdeto card caid: 0606, acs: 6.06
