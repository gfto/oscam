...
##TPLMESSAGE##\n\
	...
	<form action=\"user_edit.html\" method=\"get\">\n\
		...
		<TABLE CLASS=\"config\">\n\
			...
			<TR><TD>##TPLHELPPREFIX##user#group##TPLHELPSUFFIX##Group:</A></TD><TD><input name=\"group\" type=\"text\" size=\"20\" maxlength=\"100\" value=\"##GROUPS##\">Valid values 1-64</TD></TR>\n\
...
#define TPLCONFIGCWCYCLE "\
			...
			<TR><TD>##TPLHELPPREFIX##conf#cwcycle_maxlist##TPLHELPSUFFIX##Max Cycle List Entrys:</A></TD><TD><input name=\"cwcycle_maxlist\" type=\"text\" size=\"5\" maxlength=\"6\" value=\"##MAXCYCLELIST##\"> max Count of Cyclelist Entrys *Default 500 ** max 4000 Entrys*</TD></TR>\n\
			<TR><TD>##TPLHELPPREFIX##conf#cwcycle_keeptime##TPLHELPSUFFIX##Keep Cycletime:</A></TD><TD><input name=\"cwcycle_keeptime\" type=\"text\" size=\"5\" maxlength=\"6\" value=\"##KEEPCYCLETIME##\"> min Keep Learned Cycletime in Memory *Default 0 ** max 15 Min*</TD></TR>\n\
			<TR><TD>##TPLHELPPREFIX##conf#cwcycle_onbad##TPLHELPSUFFIX##On Bad Cycle:</A></TD><TD><SELECT name=\"cwcycle_onbad\"><option value=\"0\">0 - only Log Bad CW</option><option value=\"1\" ##ONBADCYCLE1##>1 - Drop CW</option></select></TD></TR>\n\
			<TR><TD>##TPLHELPPREFIX##conf#cwcycle_dropold ##TPLHELPSUFFIX##Drop Old CW:</A></TD><TD><SELECT name=\"cwcycle_dropold\"><option value=\"0\">0 - NO</option><option value=\"1\" ##DROPOLD##>1 - YES</option></select></TD></TR>\n"
...
const char *templates[][3] = {
	...
	,{"JSCRIPT", TPLJSCRIPT, ""}
#ifdef TOUCH
	,{"TOUCH_CSS", TPLTOUCH_CSS, "TOUCH"}
	,{"TOUCH_STATUS", TPLTOUCH_STATUS, "TOUCH"}
	,{"TOUCH_JSCRIPT", TPLTOUCH_JSCRIPT, "TOUCH"}
#endif
...
#ifdef MODULE_SERIAL
	,{"SERIALREADERTIMEOUT", TPLSERIALREADERTIMEOUT, "MODULE_SERIAL"}
#endif
#ifdef HAVE_DVBAPI
...
#endif
#ifdef WITH_LB
	,{"READERCONFIGLBWEIGHT", TPLREADERCONFIGLBWEIGHT, "WITH_LB"}
#endif
#ifdef CS_ANTICASC
...
#endif
	,{"CONFIGMENUWEBIF", TPLCONFIGMENUWEBIF, "" }
#ifdef LCDSUPPORT
	...
	,{"CONFIGCCCAM", TPLCONFIGCCCAM, "MODULE_CCCSHARE"}
	,{"CONFIGMENUCCCAM", TPLCONFIGMENUCCCAM, "MODULE_CCCSHARE"}
#endif
...
#endif
#if defined(READER_SECA) || defined(READER_VIACCESS)
	,{"UNLOCKPARENTAL", TPLUNLOCKPARENTAL, "READER_SECA,READER_VIACCESS"}
#endif
#if defined(READER_CONAX) || defined(READER_CRYPTOWORKS)
	,{"READERPINCODE", TPLREADERPINCODE, "READER_CONAX,READER_CRYPTOWORKS"}
#endif
#ifdef WITH_CARDREADER
	,{"READERCONFIGNANO", TPLREADERCONFIGNANO, "WITH_CARDREADER"}
#endif
...
#endif
#if defined(CARDREADER_SMARGO) || defined(CARDREADER_PHOENIX)
	,{"READERCONFIGSMARGO", TPLREADERCONFIGSMARGO, "CARDREADER_SMARGO,CARDREADER_PHOENIX"}
#endif
	,{"ICMAI", ICMAI, ""}
	,{"ICSTA", ICSTA, ""}
	,{"ICDEL", ICDEL, ""}
