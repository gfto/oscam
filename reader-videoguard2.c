...
int videoguard2_card_init(struct s_reader * reader, ATR newatr)
{
    ...
    /* known atrs */
    NDS_ATR_ENTRY nds2_atr_table[]={ // {atr}, atr len, base year, nds version, description
        {{ 0x3F, 0xFD, 0x13, 0x25, 0x02, 0x50, 0x00, 0x0F, 0x33, 0xB0, 0x0F, 0x69, 0xFF, 0x4A, 0x50, 0xD0, 0x00, 0x00, 0x53, 0x59, 0x02 }, 21, 1997, NDS2, "VideoGuard BSkyB (0963)"},
        {{ 0x3F, 0xFF, 0x13, 0x25, 0x03, 0x10, 0x80, 0x33, 0xB0, 0x0E, 0x69, 0xFF, 0x4A, 0x50, 0x70, 0x00, 0x00, 0x49, 0x54, 0x02, 0x00, 0x00 }, 22, 1997, NDS2, "VideoGuard Sky Italia (0919)"},
        {{ 0x3F, 0xFD, 0x13, 0x25, 0x02, 0x50, 0x80, 0x0F, 0x33, 0xB0, 0x13, 0x69, 0xFF, 0x4A, 0x50, 0xD0, 0x80, 0x00, 0x49, 0x54, 0x03 }, 21, 1997, NDS2, "VideoGuard Sky Italia (093B)"},
        {{ 0x3F, 0xFD, 0x13, 0x25, 0x02, 0x50, 0x80, 0x0F, 0x54, 0xB0, 0x04, 0x69, 0xFF, 0x4A, 0x50, 0xD0, 0x80, 0x00, 0x49, 0x54, 0x03 }, 21, 1997, NDS2, "VideoGuard Sky Italia (09CD)"},
        {{ 0x3F, 0xFF, 0x13, 0x25, 0x03, 0x10, 0x80, 0x33, 0xB0, 0x11, 0x69, 0xFF, 0x4A, 0x50, 0x50, 0x00, 0x00, 0x47, 0x54, 0x01, 0x00, 0x00 }, 22, 1997, NDS2, "VideoGuard YES DBS Israel"},
        {{ 0x3F, 0x7D, 0x11, 0x25, 0x02, 0x41, 0xB0, 0x03, 0x69, 0xFF, 0x4A, 0x50, 0xF0, 0x80, 0x00, 0x56, 0x54, 0x03}, 18, 2000, NDS2, "VideoGuard Viasat (093E)"},
        {{ 0x3F, 0x7F, 0x11, 0x25, 0x03, 0x33, 0xB0, 0x09, 0x69, 0xFF, 0x4A, 0x50, 0x70, 0x00, 0x00, 0x56, 0x54, 0x01, 0x00, 0x00 }, 20, 2000, NDS2, "VideoGuard Viasat Scandinavia"},
        {{ 0x3F, 0xFF, 0x11, 0x25, 0x03, 0x10, 0x80, 0x41, 0xB0, 0x07, 0x69, 0xFF, 0x4A, 0x50, 0x70, 0x00, 0x00, 0x50, 0x31, 0x01, 0x00, 0x11 }, 22, 1997, NDS2, "VideoGuard Sky Germany"},
        {{ 0x3F, 0xFF, 0x14, 0x25, 0x03, 0x10, 0x80, 0x41, 0xB0, 0x01, 0x69, 0xFF, 0x4A, 0x50, 0x70, 0x00, 0x00, 0x5A, 0x48, 0x01, 0x00, 0x00 }, 22, 2004, NDS2, "VideoGuard DSMART Turkey"},
        {{ 0x3F, 0xFF, 0x14, 0x25, 0x03, 0x10, 0x80, 0x54, 0xB0, 0x01, 0x69, 0xFF, 0x4A, 0x50, 0x70, 0x00, 0x00, 0x4B, 0x57, 0x01, 0x00, 0x00}, 22 , 1997, NDS2, "VideoGuard Kabel BW"},
        {{ 0x3F, 0xFF, 0x14, 0x25, 0x03, 0x10, 0x80, 0x33, 0xB0, 0x10, 0x69, 0xFF, 0x4A, 0x50, 0x70, 0x00, 0x00, 0x5A, 0x45, 0x01, 0x00, 0x00}, 22 , 2004, NDS2, "VideoGuard Get Kabel Norway"},
        {{ 0x3F, 0x7F, 0x11, 0x25, 0x03, 0x33, 0xB0, 0x09, 0x69, 0xFF, 0x4A, 0x50, 0x70, 0x00, 0x00, 0x46, 0x44, 0x01, 0x00, 0x00}, 20, 2000, NDS2, "VideoGuard Foxtel Australia (090B)"},
        {{ 0x3F, 0x7F, 0x13, 0x25, 0x04, 0x33, 0xB0, 0x02, 0x69, 0xFF, 0x4A, 0x50, 0xE0, 0x00, 0x00, 0x54, 0x42, 0x00, 0x00, 0x00}, 20, 1997, NDS2, "VideoGuard China (0988)"},
        {{ 0x3F, 0xFF, 0x14, 0x25, 0x03, 0x10, 0x80, 0x41, 0xB0, 0x02, 0x69, 0xFF, 0x4A, 0x50, 0x70, 0x80, 0x00, 0x58, 0x38, 0x01, 0x00, 0x14}, 22, 1997, NDS2, "VideoGuard TopTV (09B8)"},
        {{ 0x3F, 0xFF, 0x13, 0x25, 0x02, 0x40, 0xB0, 0x12, 0x69, 0xFF, 0x4A, 0x50, 0x90, 0x47, 0x4C, 0x00, 0x00, 0x00, 0x00, 0x00 }, 20, 2000, NDS2, "VideoGuard SkyBrasil GL23 (0942)"},
        {{ 0x3F, 0xFD, 0x13, 0x25, 0x02, 0x50, 0x80, 0x0F, 0x33, 0xB0, 0x08, 0xFF, 0xFF, 0x4A, 0x50, 0x90, 0x00, 0x00, 0x47, 0x4C, 0x01}, 21, 2004, NDS2, "VideoGuard SkyBrasil GL39 (0907)"},
        {{ 0x3F, 0xFF, 0x13, 0x25, 0x02, 0x50, 0x80, 0x0F, 0x54, 0xB0, 0x03, 0xFF, 0xFF, 0x4A, 0x50, 0x80, 0x00, 0x00, 0x00, 0x00, 0x47, 0x4C, 0x05 }, 22, 2009, NDS2, "VideoGuard SkyBrasil GL54 (0943)"},
        {{ 0x3F, 0xFF, 0x13, 0x25, 0x03, 0x10, 0x80, 0x33, 0xB0, 0x10, 0x69, 0xFF, 0x4A, 0x50, 0x70, 0x00, 0x00, 0x4E, 0x5A, 0x01, 0x00, 0x00}, 13, 1992, NDS2, "VideoGuard Sky New Zealand (096A)"},
        {{0},0,0,0,NULL},
        };
    ...
    int i=0;
    while(nds2_atr_table[i].desc) {
        if ((atr_size == nds2_atr_table[i].atr_len) && (memcmp (atr, nds2_atr_table[i].atr, atr_size) == 0)) {
            VG_BASEYEAR=nds2_atr_table[i].base_year;
            cs_ri_log(reader, "[videoguard2-reader] type: %s", nds2_atr_table[i].desc);
            break;
        }
        i++;
    }
