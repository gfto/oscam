...
void set_known_card_info(struct s_reader * reader, const unsigned char * atr, const uint32_t *atr_size)
{
  ...
  NDS_ATR_ENTRY nds_atr_table[]={ // {atr}, atr len, base year, tier start, nds version, description
    ...
    {{ 0x3F, 0xFF, 0x12, 0x25, 0x03, 0x10, 0x80, 0x41, 0xB0, 0x07, 0x69, 0xFF, 0x4A, 0x50, 0x70, 0x00,
       ...
       22, 2004, 0, NDS2, "VideoGuard Sky Germany FastMode"},
    ...
    {{ 0x3F, 0xFD, 0x12, 0x25, 0x02, 0x50, 0x00, 0x03, 0x33, 0xB0, 0x15, 0x69, 0xFF, 0x4A, 0x50, 0xF0,
       0x80, 0x03, 0x4B, 0x4C, 0x03 },
       21, 2004, 0, NDS2, "VideoGuard Kabel Deutschland (09C7) FastMode"},
    {{ 0x3F, 0xFD, 0x13, 0x25, 0x02, 0x50, 0x00, 0x03, 0x33, 0xB0, 0x15, 0x69, 0xFF, 0x4A, 0x50, 0xF0,
       0x80, 0x03, 0x4B, 0x4C, 0x03 },
       21, 2004, 0, NDS2, "VideoGuard Kabel Deutschland (09C7) FastMode"},
    {{ 0x3F, 0xFD, 0x14, 0x25, 0x02, 0x50, 0x00, 0x03, 0x33, 0xB0, 0x15, 0x69, 0xFF, 0x4A, 0x50, 0xF0,
       0x80, 0x03, 0x4B, 0x4C, 0x03 },
       21, 2004, 0, NDS2, "VideoGuard Kabel Deutschland (09C7) FastMode"},
