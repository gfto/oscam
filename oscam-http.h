...
##SIDS##\
			...
			<TR><TD>##TPLHELPPREFIX##server#blockemmbylen##TPLHELPSUFFIX##Block EMM by Len:</A></TD><TD><input name=\"blockemmbylen\" type=\"text\" size=\"20\" maxlength=\"40\" value=\"##BLOCKEMMBYLEN##\"></TD></TR>\n\
