...
static void gbox_send_gsms_ack(struct s_client *cli, uint8_t gsms_prot);
...
static void write_gsms_ack (struct s_client *cli, uint8_t gsms_prot)
{
	char tsbuf[28];
