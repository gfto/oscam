...
menu_card_readers() {
	${DIALOG} --checklist "\nChoose card reader drivers:\n " $height $width $listheight \
		...
		CARDREADER_DB2COM	"Dreambox2"					$(check_test "CARDREADER_DB2COM") \
...
do
	...
	'-l'|'--list-config')
		...
		enabled_any CARDREADER_DB2COM CARDREADER_MP35 CARDREADER_SC8IN1 CARDREADER_SMARGO CARDREADER_INTERNAL && enable_opt CARDREADER_PHOENIX >/dev/null
