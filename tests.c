...
int main(void)
{
	...
	const struct test_vec ecm_whitelist_test_vec[] = {
			...
			{ .in = "0500:81,82" },
			{ .in = "0500:81" },
			{ .in = "@123456:81",            .out = "FFFF@123456:81" },
			{ .in = "@123456:81;@000789:AA,BB,CC", .out = "FFFF@123456:81;FFFF@000789:AA,BB,CC" },
			{ .in = "81" },
			{ .in = "81,82,83" },
			{ .in = "81,82,83,84" },
			...
			{ .in = "500:1,2;60@77:a,b,z,,", .out = "0500:01,02;0060@000077:0A,0B,FFFF" },
			{ .in = "@ff:81;@bb:11,22",      .out = "FFFF@0000FF:81;FFFF@0000BB:11,22" },
			{ .in = "@:81",                  .out = "FFFF:81" },
			{ .in = "81;zzs;;;;;ab",         .out = "81,FFFF,AB" },
			{ .in = ":@",                    .out = "FFFF:FFFF" },
			{ .in = ",:,@,",                 .out = "FFFF:FFFF" },
			{ .in = "@:",                    .out = "" },
			{ .in = "@:,,",                  .out = "" },
