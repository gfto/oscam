...
int32_t Cool_Transmit (struct s_reader *reader, unsigned char * buffer, uint32_t size, uint32_t UNUSED(delay), uint32_t UNUSED(timeout));
int32_t Cool_Set_Transmit_Timeout(struct s_reader *reader, uint32_t set);
int32_t Cool_Receive (struct s_reader *reader, unsigned char * buffer, uint32_t size, uint32_t UNUSED(delay), uint32_t UNUSED(timeout));
