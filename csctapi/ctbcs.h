...
#define CTBCS_INS_PARITY		0x17	/* Set reader parity */
#define CTBCS_INS_EJECT			0x15	/* Eject ICC */


#define CTBCS_P2_PARITY_ODD		0x01
#define CTBCS_P2_PARITY_EVEN		0x02
#define CTBCS_P2_PARITY_NONE		0x03
...
#define CTBCS_P2_STATUS_PROTOCOL	0x81	/* Return ICC Protocol + Convention */
